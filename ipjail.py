...
while expe_cluster in credentials:
    ...
    admin_port = credentials [expe][4]
    ban_url_cluster1 = 'https://' + expe + ':' + admin_port + banned_url_portion
    new_items_output=Expressway_cluster(ban_url_cluster1, expe, admin_port, user_expe, pass_expe, jailed_file, roomID, bearer, state_machine, today, new_items)
    i += 1
