...
def firewall(ip, action, expe, username, secret):
    ...
    if action == 'ban' and index == '':
       ...
       data = {"Priority": priority, "Address": ip, "EndPort": 5061, "Interface": "LAN2", "Action": "Reject", "PrefixLength": 32, "Service": "Custom", "StartPort": 5060, "Transport": "TCP", "Description": "Script generated"}
       try:
